...
@SpringBootTest(classes = EurekaSearcherApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@ActiveProfiles("test")
public class EurekaSearcherApplicationTests {
